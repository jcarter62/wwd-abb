...
namespace wwd_utils {
    ...
    /// contain log data.
    /// </summary>
    public enum ABB_FileTypes { DFile, TFile };

    internal class wwdClasses {
    }
    ...
    public class dbutils {
        ...
        public dbutils() {
            sets = new AppSettings();
        }

        public dbutils(string FileName) {
            sets = new AppSettings(FileName);
        }

        public enum TableName { Tbl_File, Tbl_Total_Readings, Tbl_TReading };

        public void Truncate_Table(TableName t, ref DataClasses1DataContext dbcc) {
            switch (t) {
                case TableName.Tbl_File:
                    dbcc.ExecuteCommand("truncate table Files");
                    break;
                case TableName.Tbl_Total_Readings:
                    dbcc.ExecuteCommand("truncate table Total_Readings");
                    break;
                case TableName.Tbl_TReading:
                    dbcc.ExecuteCommand("truncate table TReadings");
                    break;
                default:
                    break;
            }
    ...
    /// </summary>
    public class EncDec {
        private static string _Key = "BlueTiger";
        //
    ...
    public static class Misc {
        ...
        /// </returns>
        public static Boolean Check_DirectoryOK(string dir) {
